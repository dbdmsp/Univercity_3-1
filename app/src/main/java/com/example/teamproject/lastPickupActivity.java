...
public class lastPickupActivity extends AppCompatActivity {

    TextView textView[] = new TextView[6];
    int arr_textview_id[] = {R.id.rnb11, R.id.rnb22, R.id.rnb33,
            R.id.rnb44, R.id.rnb55, R.id.rnb66};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pickup_last);
        ...
        mbtn_random = findViewById(R.id.rbtn2);
